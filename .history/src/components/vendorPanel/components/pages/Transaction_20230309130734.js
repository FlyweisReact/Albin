    ...
    function MyVerticallyCenteredModal(props) {
        ...
        const postHandler = async (e) => {
          ...
          try{  
            ...
            const { data } = await axios.post("https://5o53oluanh.execute-api.ap-south-1.amazonaws.com/development/FindBusRouter/createBusesInfoByAdmin" , {
              name , arrival , destination , arrival_time , destination_time , date , NumberofSeats , Pass , BoardingPoint , DropingPoint
            })
            console.log(data)
          alert("Bus Created")
              props.onHide()
