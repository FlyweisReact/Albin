  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://5o53oluanh.execute-api.ap-south-1.amazonaws.com/development/FindBusRouter/DeleteBusesByIdByAdmin/${id}`
      );
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="time"   onChange={(e) => setName(e.target.value)}/>
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="date"  onChange={(e) => setName(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="number"  onChange={(e) => setName(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
