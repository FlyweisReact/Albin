...
const CurrentPass = () => {
    ...
    const deleteData = async (id) => {
      try{
        const { data } = await axios.delete(`https://5o53oluanh.execute-api.ap-south-1.amazonaws.com/development/localhost:5010/currentPass/deletecurrentPassByAdmin/640089/${id}`)
