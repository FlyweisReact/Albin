...
const Offers = () => {
  ...
  function PostOffer(props) {
    ...
    const postHandler = async (e) => {
        e.preventDefault()
        try{
            const { data  } = await axios.post("https://5o53oluanh.execute-api.ap-south-1.amazonaws.com/development/offers/offerstouserByAdmin" , {
                image : ImageUrl , desc
            })
            console.log(data)
            alert('Offer Created')
  ...
  return (
    <>
      ...
      <p style={{ color: "black", fontSize: " 1" }}>All Offers</p>
        </div>
